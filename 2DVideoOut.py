...
recorder = ScreenRecorder(width, height, 30)
...
def DrawPoint(coordList: list,index: int,col: tuple,weight: int,xMod: int,yMod: int):
    ...
    try:
        if coordList[index][0] > 10*multiplier:
            l = [x + y for x, y in zip(coordList[index], [xMod,yMod])]
            pygame.draw.circle(screen,col,l,weight)
    except IndexError:
        pass
...
def DrawPoly(coordList: list, pointsList: list, col: tuple, weight: int):
    ...
    try:
        ...
        # print("IndexError: DrawPoly")
        pass
    except ValueError:
        # print("ValueError: DrawPoly")
        pass
...
def DrawLine(coordList:list, pointsList: list, col: tuple, weight: int):
    ...
    try:
        ...
        # print("IndexError: DrawLine")
        pass
    except ValueError:
        # print("ValueError: DrawLine")
        pass
...
def DisplayAvatar():
    ...
    #--Display Mouth--
    # DrawPoly(faceKeypointList,48,59,lipsBase,0)
    # DrawPoly(faceKeypointList,60,67,mouthInside,0)
